...
class SimpleJoystickUI(Tk):
    def __init__(
        ...
        self.jog_buttons = {
            self.ui.x_min_btn: (
                linear_jog_func,  'x_min', 'X,', '-', Sequences.x_min
            ),
            self.ui.x_max_btn: (
                linear_jog_func, 'x_max', 'X', '+', Sequences.x_max
            ),
            self.ui.y_min_btn: (
                linear_jog_func, 'y_min', 'Y', '-', Sequences.y_min
            ),
            self.ui.y_max_btn: (
                linear_jog_func, 'y_max', 'Y', '+', Sequences.y_max
            ),
            self.ui.z_min_btn: (
                linear_jog_func, 'z_min', 'Z', '-', Sequences.z_min
            ),
            self.ui.z_max_btn: (
                linear_jog_func, 'z_max', 'Z', '+', Sequences.z_max
            ),
            self.ui.rx_min_btn: (
                linear_jog_func, 'rx_min', 'Rx', '-', Sequences.rx_min
            ),
            self.ui.rx_max_btn: (
                linear_jog_func, 'rx_max', 'Rx', '+', Sequences.rx_max
            ),
            self.ui.ry_min_btn: (
                linear_jog_func, 'ry_min', 'Ry', '-', Sequences.ry_min
            ),
            self.ui.ry_max_btn: (
                linear_jog_func, 'ry_max', 'Ry', '+', Sequences.ry_max
            ),
            self.ui.rz_min_btn: (
                linear_jog_func, 'rz_min', 'Rz', '-', Sequences.rz_min
            ),
            self.ui.rz_max_btn: (
                linear_jog_func, 'rz_max', 'Rz', '+', Sequences.rz_max
            ),
            self.ui.j0_min_btn: (
                joint_jog_func, 'j0_min', 0, '-', Sequences.j0_min
            ),
            self.ui.j0_max_btn: (
                joint_jog_func, 'j0_max', 0, '+', Sequences.j0_max
            ),
            self.ui.j1_min_btn: (
                joint_jog_func, 'j1_mix', 1, '-', Sequences.j1_min
            ),
            self.ui.j1_max_btn: (
                joint_jog_func, 'j1_max', 1, '+', Sequences.j1_max
            ),
            self.ui.j2_min_btn: (
                joint_jog_func, 'j2_mix', 2, '-', Sequences.j2_min
            ),
            self.ui.j2_max_btn: (
                joint_jog_func, 'j2_max', 2, '+', Sequences.j2_max
            ),
            self.ui.j3_min_btn: (
                joint_jog_func, 'j3_mix', 3, '-', Sequences.j3_min
            ),
            self.ui.j3_max_btn: (
                joint_jog_func, 'j3_max', 3, '+', Sequences.j3_max
            ),
            self.ui.j4_min_btn: (
                joint_jog_func, 'j4_mix', 4, '-', Sequences.j4_min
            ),
            self.ui.j4_max_btn: (
                joint_jog_func, 'j4_max', 4, '+', Sequences.j4_max
            ),
            self.ui.j5_min_btn: (
                joint_jog_func, 'j5_mix', 5, '-', Sequences.j5_min
            ),
            self.ui.j5_max_btn: (
                joint_jog_func, 'j5_max', 5, '+', Sequences.j5_max
            ),
        }
        self.binds = []
        self.binds.append(Binding('empty', None))
        for (
            button, (func, name, axis, direction, sequances)
